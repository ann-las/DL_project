...
- Uploaded to this github our final trained models in the format of ckpt-files (see below).
...
- _scripts/calculate_deepTMHMM_metrics.ipynb_
- _scripts/metrics_with_confusion_matrix.ipynb_
- _scripts/create_final_plots.ipynb_
- _scripts/plot_accuracies.ipynb_
