...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 16 10:33:02 2023
...
# Set filename
tmhmm_file = open("/Users/jespermadsen/Documents/Dokumenter_Anna/KBS/7_semester/DeepLearning/Project/DeepTMHMM.partitions.json")
...
# Full dict
full_dict_outfile = open("/Users/jespermadsen/Documents/Dokumenter_Anna/KBS/7_semester/DeepLearning/Project/our_data_full.json", "w")
json.dump(our_dict, full_dict_outfile)
full_dict_outfile.close()

# Train
train_dict_outfile = open("/Users/jespermadsen/Documents/Dokumenter_Anna/KBS/7_semester/DeepLearning/Project/our_train.json", "w")
json.dump(train_dict, train_dict_outfile)
train_dict_outfile.close()

# Validation
val_dict_outfile = open("/Users/jespermadsen/Documents/Dokumenter_Anna/KBS/7_semester/DeepLearning/Project/our_val.json", "w")
json.dump(val_dict, val_dict_outfile)
val_dict_outfile.close()

# Test
test_dict_outfile = open("/Users/jespermadsen/Documents/Dokumenter_Anna/KBS/7_semester/DeepLearning/Project/our_test.json", "w")
