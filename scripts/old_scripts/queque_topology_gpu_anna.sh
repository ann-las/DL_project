...
workshop train dataset=our encoder=schnet decoder=node_label ++trainer.max_epochs=40 features=ca_sc ++optimiser.optimizer.lr=0.0001 ++optimiser.optimizer.weight_decay=0.0001 ++callbacks.early_stopping.monitor=val/loss/node_label ++callbacks.early_stopping.patience=50 task=multiclass_node_classification trainer=gpu env.paths.data=/dtu/blackhole/17/126583/Topology env.paths.output_dir=/dtu/blackhole/17/126583/Topology/output_anna_cv0_gpu_features2
