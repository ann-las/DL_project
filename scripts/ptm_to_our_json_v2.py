...
# Set filename
tmhmm_file = open(r"\Users\puqu\OneDrive - Danmarks Tekniske Universitet\Dokumenter\DeepTMHMM.partitions.json")
...
# Full dict
full_dict_outfile = open(r"\Users\puqu\OneDrive - Danmarks Tekniske Universitet\Dokumenter\our_data_full.json", "w")
json.dump(our_dict, full_dict_outfile)
full_dict_outfile.close()

# Train
train_dict_outfile = open(r"\Users\puqu\OneDrive - Danmarks Tekniske Universitet\Dokumenter\our_train.json", "w")
json.dump(train_dict, train_dict_outfile)
train_dict_outfile.close()

# Validation
val_dict_outfile = open(r"\Users\puqu\OneDrive - Danmarks Tekniske Universitet\Dokumenter\our_val.json", "w")
json.dump(val_dict, val_dict_outfile)
val_dict_outfile.close()

# Test
test_dict_outfile = open(r"\Users\puqu\OneDrive - Danmarks Tekniske Universitet\Dokumenter\our_test.json", "w")
